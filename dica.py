...
def main():
    ...
    # widgets
    title = Label(text = "Dica", font = FONT, bd = BD, fg = FG, bg = BG, relief = RLF_1)
    item_price = Entry(font = FONT, bd = BD, fg = FG, bg = BG, relief = RLF_1, justify = CENTER)
    discount_percent = Entry(font = FONT, bd = BD, fg = FG, bg = BG, relief = RLF_1, justify = CENTER)
    ...
    discount_percent.place(x = x_pos, y = y_pos, width = x_pos, height = y_pos)
